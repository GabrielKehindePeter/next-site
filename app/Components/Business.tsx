...
export default function Business() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 lg:pt-20 sm:pt-4 bg-gray-800 pb-20"  id="info">
      <div className="p-4 rounded-2xl text-amber-100">
        <h2 className="text-3xl text-amber-500 font-bold mt-15">Business</h2>
        <p>
